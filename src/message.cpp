...
namespace freelan
{
	...
	size_t message::write(void* buf, size_t buf_len, message_type _type, sequence_type _sequence, size_t _length = 0)
	{
	...
	{
		return message::write(buf, buf_len, MT_ROUTES_REQUEST, sequence);
	}
