...
namespace fscp
{
	...
	const key_derivation_algorithm_type::value_type key_derivation_algorithm_type::pbkdf2_sha256_1000 = 0x01;
	const std::string key_derivation_algorithm_type::pbkdf2_sha256_1000_string("pbkdf2-sha256-1000");
