...
/**
 * \file ethernet_address_tools.cpp
...
#include "ethernet_address_parser.hpp"
...
fl::configuration::ethernet_address_type parse_ethernet_address(const std::string& str)
{
	...
	bool r = qi::phrase_parse(first, str.end(), -custom_parser::ethernet_address[ph::ref(result) = qi::_1], qi::space);
