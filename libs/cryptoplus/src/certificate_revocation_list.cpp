...
/**
 * \file certificate_revocation_list.cpp
 * \author Julien KAUFFMANN <julien.kauffmann@freelan.org>
 * \brief A X509 certificate revocation list class.
 */

#include "x509/certificate_revocation_list.hpp"
...
{
	template <>
	x509::certificate_revocation_list::deleter_type pointer_wrapper<x509::certificate_revocation_list::value_type>::deleter = X509_CRL_free;
	...
	namespace x509
	{
		...
		certificate_revocation_list certificate_revocation_list::from_certificate_revocation_list(const void* buf, size_t buf_len, pem_passphrase_callback_type callback, void* callback_arg)
		{
