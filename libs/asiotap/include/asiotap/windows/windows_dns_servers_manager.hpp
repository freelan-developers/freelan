...
/**
 * \file windows_dns_servers_manager.hpp
...
namespace asiotap
{
	class windows_dns_servers_manager : public base_dns_servers_manager<windows_dns_servers_manager>
	{
		public:
			...
			explicit windows_dns_servers_manager(boost::asio::io_service& io_service_) :
				base_dns_servers_manager<windows_dns_servers_manager>(io_service_)
			{
			}
