...
libkfather stands as a lightweight, simple, and efficient C++ JSON parser/producer.
...
You may also find the [git repository](https://github.com/freelan-developers/libkfather) on github.
